package com.tqi.desafioBackEnd.config;
...
public class SwaggerConfig {@Bean
	...
	return new Docket(DocumentationType.SWAGGER_2)
			...
			.apis(RequestHandlerSelectors
					.basePackage("com.tqi.desafioBackEnd.controller"))
...
public static ApiInfo metadata() {
	...
	.title("API - Desafio TQI")
	.description("Projeto API Spring - Desafio TQI")
	.version("1.0.0")
...
private static Contact contact() {
	return new Contact("Desafio TQI",
